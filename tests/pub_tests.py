...
class TestPub(unittest.TestCase):
    ...
    def test_food_stock_non_duplicate(self):
        food = Food("Olives", 2.50, 2)
        food1 = Food("Crisps", 1, 1)
        self.pub.add_food(food, 50)
        self.pub.add_food(food1, 5)
        self.assertEqual(2, len(self.pub.food))
        self.assertEqual(130, self.pub.get_stock_value())
